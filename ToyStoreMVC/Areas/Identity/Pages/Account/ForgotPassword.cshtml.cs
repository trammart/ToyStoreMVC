    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(Input.Email, "[Teddy Store] Xác nhận quên mật khẩu",
                        $"<p>Xin chào bạn, </p>" +
                        "<p>Bạn đã gửi yêu cầu lấy lại mật khẩu tại website của cửa hàng<b> Teddy Store</b>. Vui lòng truy cập vào đường dẫn bên dưới để đặt lại mật khẩu.</p> " +
                        ...
                        $"<a style=\"color:white; text-decoration:none;\" href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Đặt lại mật khẩu</a></button>");

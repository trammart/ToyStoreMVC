...
namespace ToyStoreMVC.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index() 
        {
            ...
            {
                list.Price = list.Product.Price - (list.Product.Price * list.Product.Discount /100);
        ...
        {            
            ...
            {
                item.Price = item.Product.Price - (item.Product.Price * item.Product.Discount/100);

...
namespace ToyStoreMVC.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var productFromDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == id, includeProperties: "Category,Brand");
        ...
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(cartFromDb == null)
                {
                    // không có sp nào tồn tại trong cơ sở dữ liệu cho sản phẩm đó của ng dùng đó
            ...
            {
                var productFromDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == CartObject.ProductId, includeProperties: "Category,Brand,Size");
                ShoppingCart cartObj = new ShoppingCart()
                {
                    Product = productFromDb,
                    ProductId = productFromDb.Id
        ...
        {
            var data = _unitOfWork.Product.GetAll(filter: p => p.Discount > 0, includeProperties: "Category,Brand");
